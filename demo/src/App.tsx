...
const CONFIG = {
  ...
  webauthnVerifierAddress: import.meta.env.VITE_WEBAUTHN_VERIFIER_ADDRESS || "CCQKLVCZYLMM67RZVCPHMDTT7UEJNLYSIQ57GYWRNDECZGDVB7I6G23Y",
  nativeTokenContract: import.meta.env.VITE_NATIVE_TOKEN_CONTRACT || "CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC",
  ed25519VerifierAddress: import.meta.env.VITE_ED25519_VERIFIER_ADDRESS || "",
...
const KNOWN_POLICIES = [
  {
    ...
    address: import.meta.env.VITE_THRESHOLD_POLICY_ADDRESS || "CDQEUI5I6OANOUU72EUMASMYFTNZSUSYZZB746QTJOFJGTXCRRR4FHRD",
  },
  {
    type: "spending_limit" as const,
    name: "Spending Limit",
    description: "Limits spending to a maximum amount per time period",
    address: import.meta.env.VITE_SPENDING_LIMIT_POLICY_ADDRESS || "CBTH7MG5QFEAEEANZ47Y64PPV733F5K4MGVITQNYMWHDMISNBGCIJSFE",
  },
  {
    ...
    address: import.meta.env.VITE_WEIGHTED_THRESHOLD_POLICY_ADDRESS || "CD2AVNAKJIROTEZ6MZAXGML55Q3AFVRL72YXNURHT5VJES2WXNPT7MQE",
  },
];
